...
public class Constants {
    ...
    public static final String URL_PRIVACY = "https://firebasestorage.googleapis.com/v0/b/bthp-64511.appspot.com/o/dots_and_boxes_privacy_policy.html?alt=media&token=b794d4de-c278-4a44-87b6-338689e832e5";
    public static final String MY_ONLINE_NAME = "my_online_name";
    public static final String IS_GOOGLE_SIGN_IN = "is_google_sign_in";


    private final static String PACKAGE_NAME = "com.tiptop.dotsandboxes";
