package com.tiptop.dotsandboxes.services;
...
import com.tiptop.dotsandboxes.views.MusicIntentReceiver;
...
public class MusicPlayerService extends Service implements MediaPlayer.OnCompletionListener,
    ...
    public static final String ACTION_PLAY = "com.tiptop.dotsandboxes.ACTION_PLAY";
    public static final String ACTION_PAUSE = "com.tiptop.dotsandboxes.ACTION_PAUSE";
    public static final String ACTION_PREVIOUS = "com.tiptop.dotsandboxes.ACTION_PREVIOUS";
    public static final String ACTION_NEXT = "com.tiptop.dotsandboxes.ACTION_NEXT";
    public static final String ACTION_STOP = "com.tiptop.dotsandboxes.ACTION_STOP";
    ...
    public static final String ACTION_STOP_SOUND = "com.touchawesome.dotsandboxes.services.action.STOP_SOUND";
...
//    }
    ...
    private boolean removeAudioFocus() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            AudioFocusRequest focusRequest = focusRequestBuilder.build();
